...
<div id="demo1" class="main carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img src="home_slider_images/<?= $slide_image; ?>">
    </div>
    <?php } ?>
    <?php
      $get_slides = $db->query("select * from home_section_slider LIMIT 1,$count_slides");
        ...
        <div class="card-box">
          <div>
            <a href="<?= $card_link; ?>" class="subcategory">
              ...
              <picture>
                <img src="card_images/<?= $card_image; ?>">
              </picture>
            </a>
          </div>
        </div>
      ...
      <div class="row space80">
        ...
        <div class="col-md-3 col-6">
          <a href="categories/<?= $cat_url; ?>">
            <div class="grn_box">
              <img src="cat_images/<?= $cat_image; ?>" class="mx-auto d-block">
              <p><?= $cat_title; ?></p>
            </div>
          </a>
        </div>
...
<div class="container" style="max-width: 1335px !important;">
  <div class="row">
    ...
    <div class="col-md-4 pad0">
      <div class="blu_box">
        <img src="box_images/<?= $box_image; ?>" class="img-fluid mx-auto d-block">
      </div>
    </div>
    <?php } ?>
    <?php
